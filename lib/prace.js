const prace = [
  {
    ...
    sk: {
      ...
      popis: "Vytvorenie prezentačnej web stránky pre lokálneho výrobcu drevených okien a dverí. V tejto stránke je špecifický 3d prvok. Hneď v úvode môžte vidieť 3d animujúce sa okno. 3D vždy bolo aj je súčasťou našej každodennej práce.",
    },
    en: {
      nazovPopis: "Website creation and social network management",
      popis: "Creating a presentation website for a local manufacturer of wooden windows and doors. This page has a specific 3d element. Right at the beginning you can see a 3d animated window. 3D has always been a part of our daily work.",
    },
  },
  {
  ...
  },
  {
    ...
    sk: {
      ...
      popis: "Fair street food je lokálna reštaurácia v Trenčíne. Tento projekt momentálne pripravujeme. Budeme robiť kompletnú dizajnovú aj prográmatorskú časť. Môžte sa na to tešiť, už teraz vieme, že to bude perfektné. ",
    },
    en: {
      nazovPopis: "Upcoming project for a local restaurant",
      popis: "Fair street food is a local restaurant in Trenčín. We are currently preparing this project. We will do the complete design and programming part. You can look forward to it, we already know that it will be perfect.",
    },
  },
];
